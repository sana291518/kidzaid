...
class SplintersActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonVideo.setOnClickListener {
            startActivity(Intent(this, SplintersVideoActivity::class.java))
        }

        buttonQuiz.setOnClickListener {
            startActivity(Intent(this, SplintersQuizActivity::class.java))
        }
    }
}
