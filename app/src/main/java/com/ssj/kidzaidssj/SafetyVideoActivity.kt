...
class SafetyVideoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_safety_video)
        ...
        val videoUri = Uri.parse("android.resource://$packageName/${R.raw.safety_rules}")
    ...
    private fun updateLikeUnlikeCounts() {
        ...
        thumbsUp.setColorFilter(
            ContextCompat.getColor(
                this, if (isLiked) R.color.holo_blue_light else R.color.colorGrey
            )
        )

        thumbsDown.setColorFilter(
            ContextCompat.getColor(
                this, if (isDisliked) R.color.holo_red_light else R.color.colorGrey
            )
        )
    }
