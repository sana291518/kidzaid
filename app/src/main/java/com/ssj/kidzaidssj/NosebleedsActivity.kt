...
class NosebleedsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonVideo.setOnClickListener {
            startActivity(Intent(this, NosebleedVideoActivity::class.java))
        }

        buttonQuiz.setOnClickListener {
            startActivity(Intent(this, NosebleedsQuizActivity::class.java))
        }
    }
}
