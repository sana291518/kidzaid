...
class BurnsVideoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_burns_video)
        ...
        val videoUri = Uri.parse("android.resource://${packageName}/${R.raw.burns_video}")
